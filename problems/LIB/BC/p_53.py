...
class SymbolicRegression():
    ...
    def read_fit_cases(self):
        self.df_25 = pd.read_csv('resources/LIB/BC/P_last_25.txt', sep=' ')
        self.X_25 = self.df_25.values[:,:-1]
        self.Y_25 = self.df_25.values[:,-1]
        self.df_53 = pd.read_csv('resources/LIB/BC/P_last_53.txt', sep=' ')
        self.X_53 = self.df_53.values[:,:-1]
        self.Y_53 = self.df_53.values[:,-1]
        self.df_74 = pd.read_csv('resources/LIB/BC/P_last_74.txt', sep=' ')
        self.X_74 = self.df_74.values[:,:-1]
        self.Y_74 = self.df_74.values[:,-1]
        self.df_102 = pd.read_csv('resources/LIB/BC/P_last_102.txt', sep=' ')
    ...
    def evaluate(self, individual):
        ...
        fitness_train = error_53
        fitness_val = np.mean([error_25,error_74,error_102])
