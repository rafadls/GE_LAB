...
class SymbolicRegression():
    ...
    def read_fit_cases(self):
        self.df_25 = pd.read_csv('resources/LIB/CI/df_cdrag_25.txt',sep=',').sample(n=1000)
        self.X_25 = self.df_25.values[:,:-1]
        self.Y_25 = self.df_25.values[:,-1]
        self.df_53 = pd.read_csv('resources/LIB/CI/df_cdrag_25.txt',sep=',').sample(n=1000)
        self.X_53 = self.df_53.values[:,:-1]
        self.Y_53 = self.df_53.values[:,-1]
        self.df_74 = pd.read_csv('resources/LIB/CI/df_cdrag_25.txt',sep=',').sample(n=1000)
        self.X_74 = self.df_74.values[:,:-1]
        self.Y_74 = self.df_74.values[:,-1]
        self.df_102 = pd.read_csv('resources/LIB/CI/df_cdrag_25.txt',sep=',').sample(n=1000)
